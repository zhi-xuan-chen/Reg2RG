...
class RadGenomeDataset_Train(PersistentDataset):
    ...
    def prepare_samples(self):
        ...
        if os.path.exists('/home/chenzhixuan/Workspace/FineGrainedCTRG/src/Dataset/train_samples.pkl'):
            samples = pickle.load(open('/home/chenzhixuan/Workspace/FineGrainedCTRG/src/Dataset/train_samples.pkl', 'rb'))
        else:
            ...
            with open('/home/chenzhixuan/Workspace/FineGrainedCTRG/src/Dataset/train_samples.pkl', 'wb') as f:
    ...
    def __init__(self, text_tokenizer, data_folder, mask_folder, csv_file, cache_dir, max_region_size=10, max_img_size = 1, image_num = 32, region_num=33, max_seq=2150, resize_dim=500, voc_size=32000, force_num_frames=True):
        # text_tokenizer
        self.text_tokenizer = AutoTokenizer.from_pretrained(
                text_tokenizer,
        )
    ...
    def __getitem__(self, index):
        ...
        text_tensor = self.text_tokenizer(
            prompt + ' ' + gt_report, max_length=self.max_seq, truncation=True, padding="max_length", return_tensors="pt"
        )
        text_input = text_tensor["input_ids"][0]
        attention_mask = text_tensor["attention_mask"][0]
