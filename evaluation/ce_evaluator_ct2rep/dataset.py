...
class CTDataset(Dataset):
    ...
    def __init__(self, data_files, class_count, label_cols, report_column, max_length, augment = False ,infer=False):
    ...
    def __getitem__(self,idx):
        text_comment = self.data_files[self.report_column][idx]
